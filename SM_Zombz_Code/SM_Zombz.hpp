...
class SM_Zombz
{
	...
	*/
	...
	// WIP, may / may not be very broken.
	...
	SM_InfectionChanceHigh = 5; // chance to increase a random infection ammount
	SM_InfectionChanceLow = 0; // chance to increase a random infection ammount
	...
	*/
	...
	SM_GiveCrypto = true; // enable giving player crpyto when killed a zombie. //Epoch only
	...
	*/
	...
	// https://github.com/StokesMagee/SM_Zombz
